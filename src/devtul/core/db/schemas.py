...
class markdownSchema(BaseModel):
    ...
    included_files: int = Field(..., description="Number of included files after filtering")
    generated_at: str = Field(..., description="Timestamp of when the metadata was generated")
...
class GitMetadata(BaseModel):
    ...
    uncommitted_changes: bool = Field(..., description="Whether there are uncommitted changes")
